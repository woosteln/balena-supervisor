...
* Keep locks if purge is called [Michel Wohlert]
* Keep virtual locks when lock was called with force [Michel Wohlert]
* Add lockKeepTimeout config [Michel Wohlert]
* Check force to be truthy in v2 purge [Michel Wohlert]
